...
darshil = {
    ...
    "passion"    : ["Multi-Agent AI", "Machine Learning", "LLM Systems"],
    "currently"  : "Building AI agents that solve real-world problems",
    "looking_for": "AI/ML Internship 🚀",
    "fun_fact"   : "I led 2 teams to hackathon finals in my first year of college",
}
```

I'm a first-year AI/ML engineer who doesn't wait to build — I ship. From bias-aware hiring platforms to agricultural AI advisors, I build **multi-agent systems** that solve real problems. I'm most excited about the intersection of **Machine Learning**, **LLM reasoning**, and systems that actually work in production.
